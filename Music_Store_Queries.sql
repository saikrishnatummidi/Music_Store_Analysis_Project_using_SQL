...
/* Steps to Solve: first most popular music genre and second need data at country level. */
...
/* Steps to Solve: first find the most spent on music for each country and second filter the data for respective customers. */
